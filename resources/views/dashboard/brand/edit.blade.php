...
@section('content')
        @include('layouts.dashboard.breadcrumb', ['component' => 'Edit Brand'])
            <!-- Header Section -->
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea 
                            ...
                            name="description_ar" 
                            rows="3" 
                            placeholder="Enter Arabic Description">{{ $brand->description_ar }}</textarea>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea 
                            ...
                            name="description_en" 
                            rows="3" 
                            placeholder="Enter English Description">{{ $brand->description_en }}</textarea>
