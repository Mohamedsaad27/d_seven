...
@section('title', trans('website.single_product'))
@section('content')
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                <div class="main-img">
                                    <img src="assets/images/3.jpg" id="current" alt="#">
                                </div>
                                <div class="images">
                                    <img src="assets/images/2.jpg" class="img" alt="#">
                                    <img src="assets/images/3.jpg" class="img" alt="#">
                                    <img src="assets/images/4.jpg" class="img" alt="#">
                                    <img src="assets/images/4.jpg" class="img" alt="#">
                                    <img src="assets/images/3.jpg" class="img" alt="#">
                                </div>
                            </main>
